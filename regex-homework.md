...
My name is **Bryon Ball**. I specialize in building applications for desktop, web, and mobile devices. I am currently enrolled in the **Flex Stack Coding Boot Camp** at
**Michigan State University** where I am learning to develop, test, and deploy web and mobile applications using HTML, CSS, JavaScript, Bootstrap, Tailwind CSS, JQuery, Node.JS, Express.JS, Sequelize, MySQL, JawsDB, Express Handlebars, and other frameworks and libraries including Inquirer, Jest, Dotenv, Express Session, Connect Session
Sequelize, Bcrypt, DayJS, Google Fonts, and Font Awesome.

Would you like to know more about the _cool_ projects I am building? Check them in [Git Hub](https://github.com/bryonbsmb1) Want to connect, follow, or contact me to talk about my
professional career? Check out my [LinkedIn](https://www.linkedin.com/in/bryonball/) Profile.
